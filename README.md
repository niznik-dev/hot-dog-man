...
This project was never supposed to exist. It emerged, fully formed, during a routine test of bell notifications in [Claude Code](https://claude.ai/claude-code). One moment we were checking if alerts fired properly. The next, there was a hot dog with googly eyes, a mustard zigzag, and he looked...surprisingly good.
...
Or visit the [live page](https://niznik-dev.github.io/hot-dog-man/) via GitHub Pages.
